...
export default function CustomerPayments() {
  ...
  useEffect(() => {
    ...
    .then(d => {
      ...
      setMethods(list);
      // Si el método actual ya no está disponible, resetear a cash
    ...
    .catch(() => {
      ...
      setMethods([
        ...
        { id:'card',  label:'Tarjeta de crédito/débito',   available:false },
        { id:'spei',  label:'SPEI / Transferencia',        available:false },
      ]);
    })
