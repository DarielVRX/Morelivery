...
// UPDATE: soporte para bottomOffset prop para posicionamiento dinámico
...
function ZoneInfoCard({ zone, onSuggest, onClose, onVote, userId, votedIds = new Set(), voting = false, bottomOffset = 80 }) {
...
// ── ZoneLayer ─────────────────────────────────────────────────────────────────
export default function ZoneLayer({ map, zones = [], onZoneClick, token, userId, bottomOffset = 80 }) {
